...
```sh
python -m pip install "https://github.com/yugao-gaos/GAOS-TurnBasedGrid-SDK/releases/download/v0.19.0/gaos_turn_based_grid_sdk-0.19.0-py3-none-any.whl"
```

For a different release, replace both `0.19.0` occurrences with the same
