...
| `./room-agent-runtime` | Provider-neutral final-text routing, authenticated disclosure, channel-isolated provider work and transcripts, room-global speech arbitration, captions, and reconnect state |
